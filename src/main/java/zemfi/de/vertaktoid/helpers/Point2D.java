...
public class Point2D implements Comparable<Point2D>, Parcelable
{
    ...
    public static final Creator<Point2D> CREATOR = new Creator<Point2D>() {
        @Override
        public Point2D createFromParcel(Parcel in) {
            return new Point2D(in);
        }
